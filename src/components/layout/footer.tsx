...
const footerNav = [
  {
    ...
    links: [
      ...
      { label: 'Start a Garden', href: '/get-involved/start-a-garden' },
      { label: 'Growers', href: '/get-involved/growers' },
      { label: 'Team Monarch', href: '/monarchs' },
    ],
  },
  {
    title: 'Get Involved',
  ...
  },
  {
    title: 'About',
    links: [
      { label: "Katie's Story", href: '/about' },
  ...
  return (
    <footer className="texture-grain relative bg-forest-dark text-stone-200">
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-stone-300">
              Empowering youth to start and maintain vegetable gardens and
              donate the harvest to help feed people in need.
            </p>
            {/* Contact Info */}
            <div className="mt-4 space-y-1 text-sm text-stone-300">
              <p>P.O. Box 1841, Summerville, SC 29484</p>
              <p>
                <a href="tel:+18433273366" className="transition-colors hover:text-white">(843) 327-3366</a>
              </p>
              <p>
                <a href="mailto:katie@katieskrops.com" className="transition-colors hover:text-white">katie@katieskrops.com</a>
              </p>
            </div>
            {/* Social Links */}
            <div className="mt-4 flex gap-3">
              ...
              <a
                href="https://twitter.com/KatiesKrops"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-stone-300 transition-colors hover:bg-white/20 hover:text-white"
                aria-label="Twitter"
              ...
              <a
                href="https://www.youtube.com/channel/UC8RIlFJ_BZar0WTsUpH_4HQ/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-stone-300 transition-colors hover:bg-white/20 hover:text-white"
                aria-label="YouTube"
        ...
        {/* Bottom Bar */}
        <div className="mt-10 border-t border-white/10 pt-6 text-center text-sm text-stone-400">
          <p>
            &copy; {new Date().getFullYear()} Katie&apos;s Krops. All rights
