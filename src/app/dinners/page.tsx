      ...
      <section className="relative overflow-hidden bg-forest px-4 py-24 sm:py-32">
        ...
        <div className="relative mx-auto max-w-7xl text-center sm:px-6 lg:px-8">
          <h1 className="font-display text-4xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">
            Community
            <br />
            <span className="text-sun">Dinners</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            Free meals prepared with love, using produce from our gardens.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex justify-center">
            <div className="rounded-2xl border border-border bg-white p-10 text-center shadow-sm">
              <p className="font-display text-5xl font-bold text-forest sm:text-6xl">
                105,000+
              </p>
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-stone-600">
              Our community dinners rely on volunteers like you. Here are a few
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-white/80">
              ...
              our community dinners possible. Sign up today and be part of
