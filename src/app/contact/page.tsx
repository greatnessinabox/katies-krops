...
const additionalContacts = [
  {
    label: 'Speaking & Media Requests',
    email: 'Stacy@KatiesKrops.com',
  },
  {
    label: 'Classroom Waitlist',
    email: 'erin@katieskrops.com',
  },
  {
    label: 'Dinner Delivery Requests',
    email: 'delivery@katieskrops.com',
  },
]
          ...
          <div className="grid gap-12 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="mt-4 text-stone-600">
                We do not maintain set office hours &mdash; much of our time is
                spent in the garden or out in the community. Email is the best
                way to reach us with detailed questions.
              </p>
